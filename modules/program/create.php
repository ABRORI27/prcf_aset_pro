...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if ($nama_program == '' || $tahun_anggaran == '' || !$aset_id) {
    ...
    if (mysqli_query($conn, $sql)) {
      ...
      // 2️⃣ Update aset_barang agar kolom program_pendanaan diisi dengan ID program baru
      $update_aset = "UPDATE aset_barang SET program_pendanaan='$program_id' WHERE id='$aset_id'";
