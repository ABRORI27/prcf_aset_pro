...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  $kategori_barang     = (int) $_POST['kategori_barang'];
  $lokasi_barang       = (int) $_POST['lokasi_barang'];
  ...
  if (!$nama_barang || !$jumlah_unit || !$kategori_id || !$lokasi_id || !$kondisi_barang) {
    ...
    $sql = "INSERT INTO aset_barang 
      (nama_barang, deskripsi, jumlah_unit, nomor_seri, harga_pembelian, tanggal_perolehan, kondisi_barang, kode_barang, kategori_barang, program_pendanaan, lokasi_barang, foto_barang, status_penggunaan, user_input, created_at)
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, NOW())";
...
<div class="page">
  ...
  <form method="post" class="form-section">
    ...
    <input type="number" name="program_pendanaan" placeholder="ID program (opsional)">

    <label>Lokasi Barang <span style="color:red">*</span></label>
    <input type="number" name="lokasi_barang" required placeholder="ID lokasi">
