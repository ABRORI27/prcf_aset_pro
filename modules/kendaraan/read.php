      ...
      <tbody>
        ...
        <?php $no = 1; while ($row = mysqli_fetch_assoc($result)): ?>
          <tr>
            ...
            <td>
              <a href="update.php?nomor_seri=<?= $row['nomor_seri'] ?>" class='btn'>Edit</a>
              <a href="delete.php?nomor_seri=<?= $row['nomor_seri'] ?>" class='btn red' onclick="return confirm('Yakin ingin menghapus data ini?')">Hapus</a>
            </td>
          </tr>
        <?php endwhile; ?>  
      <?php else: ?>
