...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if ($nama_lokasi == '' || $aset_id == 0) {
    ...
    if (mysqli_query($conn, $sql)) {
      ...
      // Pastikan kategori yang dimasukkan valid (id harus ada di kategori_barang)
      $kategori_id = 1; // ubah sesuai ID kategori yang valid

      // 2️⃣ Update aset_barang dengan lokasi_barang + kategori_barang
